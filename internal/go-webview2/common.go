...
type WebView interface {
	...
	// SetBounds updates only the embedded WebView controller bounds within the
	// native window client area. This is useful when hosting additional native
	// child controls beside the WebView.
