...
// startSOCKS5 starts a local SOCKS5 proxy that routes through tsnet
func startSOCKS5(ts *tsnet.Server, listenAddr string) (net.Listener, error) {
...
// handleSOCKS5 implements a minimal SOCKS5 server (CONNECT only, no auth)
