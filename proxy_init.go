...
func init() {
	...
	os.Setenv("WEBVIEW2_ADDITIONAL_BROWSER_ARGUMENTS",
		"--proxy-server=socks5://127.0.0.1:1080 --proxy-bypass-list=127.0.0.1;localhost --force-dark-mode --enable-features=WebContentsForceDark --disable-web-security --allow-running-insecure-content --disable-features=CrossOriginOpenerPolicy,FrameAncestorsCheck")
}
